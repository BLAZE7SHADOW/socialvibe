...
export const initializeSocket = (io: Server) => {
  ...
  io.on('connection', (socket: AuthenticatedSocket) => {
    ...
    // Note: Message sending is handled via API calls (messageController.sendMessage)
    // Socket.IO is used for real-time features like typing indicators and notifications
    // The messageController already emits 'new_message' events properly
